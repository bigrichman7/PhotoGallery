...
public class ThumbnailDownloader<T> extends HandlerThread {
    ...
    //Используется для идентификации сообщений как запросов на загрузку
    private static final int MESSAGE_DOWNLOAD = 0;

    //Здесь хранится ссылка на объект Handler
    ...
    //target - выполняет функции идентификатора загрузки
